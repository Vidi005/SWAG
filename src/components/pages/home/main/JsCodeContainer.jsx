...
const JsCodeContainer = ({ t, isDarkMode, isLoading, isGenerating, responseResult, areTextsWrapped, isJSCodeCopied, changeTextView, copyToClipboard }) => {
  if (isLoading) {
    return (
          ...
          <div className="flex items-center px-1 text-cyan-900 dark:text-gray-50">
            {
              isGenerating
                ? (
                  <React.Fragment>
                    <div className="border-t-2 border-r-2 border-t-yellow-900 border-r-yellow-900 dark:border-t-white dark:border-r-white w-5 h-5 m-1 animate-spin rounded-full"></div>
