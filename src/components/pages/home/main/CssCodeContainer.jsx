...
const CssCodeContainer = ({ t, isDarkMode, isLoading, isGenerating, responseResult, areTextsWrapped, isCSSCodeCopied, changeTextView, copyToClipboard }) => {
  if (isLoading) {
    return (
    ...
    return (
      <article className="flex flex-col h-[40vh] lg:h-full bg-cyan-100 dark:bg-cyan-900 duration-200">
        ...
        <div className="css-code-content flex-auto h-0 w-screen lg:w-full text-sm leading-tight">
