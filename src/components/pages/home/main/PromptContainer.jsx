...
const PromptContainer = ({ t, state, handleCurrentPromptChange, handleLastPromptChange, pickImage, removeImage, generatePrompt, regeneratePrompt, onEditHandler, onCancelHandler }) => (
            ...
            : <React.Fragment>
                {
                  state.isEditing
                    ...
                    : (
                      <div className="flex flex-col items-end justify-end flex-auto h-0 w-full mr-24 duration-200">
                        <p className="bg-white dark:bg-gray-700 max-h-full max-w-[80%] p-2 text-justify text-cyan-900 dark:text-gray-100 duration-200 shadow-md dark:shadow-white/50 overflow-y-auto">{state.lastPrompt}</p>
