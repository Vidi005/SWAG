            ...
            : <React.Fragment>
                {
                  state.isEditing
                    ? (
                        <div className="flex flex-col items-end justify-end w-full px-12 py-2 duration-200">
                          <textarea onChange={handleLastPromptChange} value={state.lastPrompt} className="grow w-full border border-cyan-900 dark:border-none bg-cyan-100 dark:bg-gray-700 p-2 text-justify text-cyan-900 dark:text-gray-100 duration-200 overflow-y-auto rounded-md" required></textarea>
