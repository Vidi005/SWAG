    ...
    >
      <aside className="absolute left-0 inset-y-0 w-3/4 md:w-1/2 flex flex-col border-y border-r border-y-cyan-900/25 border-r-cyan-900/25 dark:border-y-white/25 dark:border-r-white/25 bg-cyan-100 dark:bg-gray-700 overflow-x-hidden">
        ...
        <section className="relative flex items-center p-2 z-10 animate__animated animate__fadeInLeft animate__faster">
          <input
            type="search"
            className="grow border border-cyan-900 dark:border-gray-50 bg-cyan-50 dark:bg-gray-500/25 w-full mr-1 p-1 text-base text-cyan-700 dark:text-white rounded-lg shadow-inner dark:shadow-white/50 backdrop-blur-sm"
          ...
          <Listbox value={sortBy} onChange={sortHandler}>
            ...
            >
              <Listbox.Options className="absolute max-h-96 flex flex-col items-center bg-cyan-100/75 dark:bg-gray-700/75 top-5 right-0 p-1 ring-1 ring-cyan-900/50 dark:ring-white/50 backdrop-blur-sm rounded-md shadow-md dark:shadow-white/50 overflow-y-auto">
